---
description: AnyRPG supports UMA via the AnyRPG UMA Addon
---
...
The Unity Package Manager should open in Unity.  If you do not see the UMA 2 package, click **My Assets** and then type "UMA 2" in the search box.  If you have not downloaded the package yet, click _Download_.  Then click the _Import_ button.
