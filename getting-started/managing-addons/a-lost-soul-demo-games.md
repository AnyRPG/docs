---
description: >-
  Demos of the game, A Lost Soul, created using the
  anyrpg-cc0-fantasy-content-pack assets.
---
...
Follow the directions to install [UMA](uma-installation.md) and the [CC0 Fantasy Content Pack](cc0-fantasy-content-pack.md).
...
Play the [demo games](../included-sample-games.md).
