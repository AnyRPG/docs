...
The Billboard Wizard is designed to make billboards of 3D models.  The recommended workflow is to open a 3D model prefab in the Unity Editor before accessing the wizard.
...
<div align="left"><figure><img src="../.gitbook/assets/image (163).png" alt="" width="416"><figcaption></figcaption></figure></div>
...
It is recommended to experiment with the rotation of the item to ensure the item fits in the image frame from all sides.
